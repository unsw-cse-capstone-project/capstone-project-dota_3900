...
class Recommend:
    ...
    def recommend_by_publishedDate(publishedDate, number, book_id):
        df = Recommend.get_recommend_list()
        # df = df.sort_values(by=['published_date', 'popular'], ascending=False)
